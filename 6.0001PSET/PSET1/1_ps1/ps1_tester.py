...
if student_c:
	...
	initial_deposit = 5000
        #there are two acceptable actual_r values because of a typo in the pset -oceliker
	actual_r = "It is not possible to pay the down payment in four years."
        actual_r_2 = "It is not possible to pay the down payment in three years."
	student_r, student_steps = student_c.part_c(initial_deposit)
	if not (student_r == actual_r or student_r == actual_r_2):
		print("FAILED")
